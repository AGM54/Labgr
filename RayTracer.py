...
raytracer.envMap = pygame.image.load("natural.bmp")
...
##raytracer.scene.append(Ellipsoid(position=(0, 0, -6), a=1.5, b=1, c=1, material=glass))
raytracer.scene.append(Ellipsoid(position=(0, 0, -6), radii=(1, 1.5, 1), material=brick))  # Cambiada para ser más "vertical"
raytracer.scene.append(Ellipsoid(position=(-3, 1, -8), radii=(2.5, 1.5, 2), material=diamond))
raytracer.scene.append(Ellipsoid(position=(1.5, -2, -5), radii=(1, 0.5, 0.5), material=water))
